...
public:
	...
	void Print ();
        ...
        // used for a string version of order maker. Used to write meta inf in 
        //sorted file meta files
        const char* toString();
        
        void SetNumAtts(int n);
        void SetAttAndType(int arrayOffset, int attNumFromCatalog, Type t);
