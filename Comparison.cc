...
void OrderMaker :: SetNumAtts(int n) {
    numAtts=n;
}

void OrderMaker :: SetAttAndType(int arrayOffset, int attNumFromCatalog, Type t) {
    whichAtts[arrayOffset] = attNumFromCatalog;
    whichTypes[arrayOffset] = t;
}
